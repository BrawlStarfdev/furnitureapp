      ...
      <div class="row col-6 pb-4 pr-1">
        <div class="dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            ...
            <a class="dropdown-item" @click="consoleFunction">console</a>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    sortI(name) {
      ...
      return (this.cards = this.it.filter(
    ...
    consoleFunction() {
      console.log("state: ", this.$store.state.items);
    },
  },
  computed: {
    sliceCards() {
